...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.player_sprite = arcade.Sprite("creature-0.png", SPRITE_SCALING_PLAYER)
        ...
        for i in range(50):
            ...
            good_sprite = Coin("coin_01.png", SPRITE_SCALING_COIN)
            bad_sprite = Coin("creature-3.png", SPRITE_SCALING_COIN)
            ...
            self.all_sprites_list.append(bad_sprite)
            ...
            # Add the coin to the lists
            self.all_sprites_list.append(good_sprite)
    ...
    def on_update(self, delta_time):
        ...
        good_hit_list = arcade.check_for_collision_with_list(self.player_sprite, self.bad_sprite_list)
        bad_hit_list = arcade.check_for_collision_with_list(self.player_sprite, self.good_sprite_list)
        ...
        for bad_sprite in bad_hit_list:
            hit_sound = arcade.load_sound("arcade_resources_sounds_hit4.wav")
